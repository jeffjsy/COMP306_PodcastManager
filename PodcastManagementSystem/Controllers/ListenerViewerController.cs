...
namespace PodcastManagementSystem.Controllers
{
    public class ListenerViewerController : Controller
    {
        ...
        public ListenerViewerController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: ListenerViewer/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ListenerViewer/Create
